...
function DemoGeneralPatternGrid() : DemoGeneralPattern("Grid") constructor {
	cols = 4;
	rows = 4;
	noiseX = 1;
	noiseY = noiseX;
...
function DemoGeneralPatternBrick() : DemoGeneralPattern("Brick") constructor {
	cols = 4;
	rows = 8;
	horizontal = true;
...
function DemoGeneralPatternSlice() : DemoGeneralPattern("Slice") constructor {
    count = 8;
    angle = 45;
