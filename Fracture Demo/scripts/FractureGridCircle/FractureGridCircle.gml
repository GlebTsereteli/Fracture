...
///
/// @desc Fractures the given circle-shaped instance into a grid of quads clipped to the circle boundary, defined by the number of columns and rows.
