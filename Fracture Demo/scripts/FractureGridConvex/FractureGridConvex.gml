...
/// 
/// @desc Fractures the given convex-shaped instance into a grid of quads clipped to the convex hull, defined by the number of columns and rows.
...
function FractureGridConvex(_inst, _cols, _rows, _noiseX = 1, _noiseY = _noiseX) {
	__FRACTURE_START;
