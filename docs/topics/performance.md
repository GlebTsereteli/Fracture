...
- **Match the shape to the sprite.** Choose the :Convex: shape that best fits the sprite you're fracturing. Box is cheapest, then Circle, then Hull, so don't reach for Hull unless the sprite is genuinely irregular.
