...
- You'll need walls or colliders with physics fixtures for Pieces to collide and bounce against. Fracture doesn't create any world geometry for you — if your walls aren't physics-enabled, Pieces will only collide with each other and fall straight through.
